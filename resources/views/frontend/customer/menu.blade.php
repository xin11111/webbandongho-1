<div class="col-md-3 pb-4">
	...
	<div class="list-group d-none d-md-block menu-customer-block">
		...
		<a href="{{url('/customer/change-password')}}" class="list-group-item list-group-item-action {{(request()->is('customer/change-password'))? 'list-group-item-secondary text-danger' :''}}"><i class="fas fa-key"></i> Thay đổi mật khẩu</a>
